...
<template>
  <div class="flex flex-col m-auto 2xl:mx-auto mt-10 md:mt-20 2xl:mt-40 w-fit md:grid md:grid-cols-2 grid-flow-col-dense md:gap-x-12 xl:gap-x-24 2xl:gap-x-52 font-content">
    <div class="w-fit text-lg flex flex-col mx-5 md:mx-0 md:ml-24">
      <h1 class="font-bold text-4xl text-header-text 2xl:w-prose max-w-lg font-heading">DevC<sup>2</sup></h1>
      ...
      <h2 class="font-bold text-header-text text-4xl">What We Offer</h2>
         <Card name="Resources" :border="true">
            <p>
               We provide resources to aid you with your journey along the computer science pathway, such as information on how to get free courses and services
            </p>
         </Card>
         <Card name="Networking" :border="true">
            <p>
               In order to help you succeed in the land of computer science, ARPC provides an excellent opportunity to network with others on the CS path
            </p>
         </Card>
         <Card name="Skill / Skill training" :border="true">
            <p>
               Not only do we provide resources to sharpen your skills in CS, we (and our members) are resources to hone your skills like specific languages, backend development, and frontend development
            </p>
         </Card>
